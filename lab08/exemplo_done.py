...
botao3 = QtGui.QPushButton('Aumenta Delay')
proxy3.setWidget(botao3)
botao3.clicked.connect(aumenta_coleta)

proxy4 = QtGui.QGraphicsProxyWidget()
botao4 = QtGui.QPushButton('Diminui Delay')
proxy4.setWidget(botao4)
botao4.clicked.connect(diminui_coleta)
